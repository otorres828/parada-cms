...
#[Layout('layouts.cms')]
class SavePago extends Component
{
    #[Locked]
    ...
    public function render()
    {
        ...
        return view('livewire.admin.pagos.save-pago', ['pago' => $this->pago_id ? $this->findPago() : null, 'capabilities' => Access::capabilities('pagos'), 'options_reserva_id' => $options_reserva_id]);
    }
