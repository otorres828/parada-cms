...
class CheckPermission
{
    private const ROUTE_PERMISSIONS = [
        ...
        'admin.campanas.list' => ['campanas', 'list'],
        'admin.campanas.detail' => ['campanas', 'detail'],
        'admin.campanas.edit' => ['campanas', 'edit'],
        'admin.campanas.add' => ['campanas', 'add'],
        'admin.settings.general' => ['settings', 'general'],
        'admin.settings.payments' => ['settings', 'payments'],
        'admin.settings.withdrawals' => ['settings', 'withdrawals'],
        ...
        'admin.movimientos.list' => ['movimientos', 'list'],
        'admin.movimientos.detail' => ['movimientos', 'detail'],
        ...
        'admin.reportes.companies' => ['reportes', 'companies'],
        'admin.reportes.finance' => ['reportes', 'finance'],
        'admin.pagos.list' => ['pagos', 'list'],
        'admin.pagos.detail' => ['pagos', 'detail'],
        'admin.pagos.add' => ['pagos', 'add'],
        'admin.reportes.sales' => ['reportes', 'sales'],
        'admin.reservas.list' => ['reservas', 'list'],
        'admin.reservas.detail' => ['reservas', 'detail'],
        'admin.retiros.list' => ['retiros', 'list'],
        'admin.retiros.detail' => ['retiros', 'detail'],
        'admin.retiros.add' => ['retiros', 'add'],
        'admin.retiros.review' => ['retiros', 'review'],
