...
<div x-data="formDeposit" class="py-3">
    ...
    <x-layout.error />
    <form id="formDepositForm" x-ref="form" @submit.prevent="preSave" novalidate>
        ...
        <x-form.container-sm>
            ...
            <div class="mb-3">
                ...
                <input type="search" class="form-control mb-2" placeholder="Buscar opciones..."
                    aria-label="Buscar Reserva pagada"
            ...
            <label class="form-label" for="formDeposit-proof">
                Comprobante (PDF, JPG o PNG, máximo 5 MB)
            </label>
            <input id="formDeposit-proof" name="comprobante" class="form-control" type="file"
