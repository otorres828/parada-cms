{{--
    PAGOS RECIBIDOS — FORMULARIO
    --------------------------------------------------------------------------
    Permite registrar el pago asociado a una reserva con referencia, método, fecha y datos de
    respaldo, mostrando las validaciones del registro.
